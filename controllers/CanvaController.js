const { pool } = require("../db/db_config.js");
const { CurrentFolder } = require("../models/CurrentFolder");
const jimp = require("jimp");
const { region, s3Client } = require("../utils/s3Client");
const { PutObjectCommand } = require("@aws-sdk/client-s3");
const { Design } = require("../models/CanvaDesign");
 ...
 */
const resourceFind = async (req, res) => {
 ...
 */
const resourceGet = async (req, res) => {
  const { id } = req.body;
  if (!id) {
    return res.send({
      type: "ERROR",
